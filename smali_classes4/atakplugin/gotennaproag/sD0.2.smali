...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/sD0;->a:Ljava/lang/Object;

    new-instance v2, Latakplugin/gotennaproag/sE;

    invoke-direct {v2}, Latakplugin/gotennaproag/sE;-><init>()V

    iput-object v2, p0, Latakplugin/gotennaproag/sD0;->b:Latakplugin/gotennaproag/eS;

    iput-object v0, p0, Latakplugin/gotennaproag/sD0;->c:Ljava/lang/String;

    iput-object v1, p0, Latakplugin/gotennaproag/sD0;->e:Ljava/security/SecureRandom;

    const/4 v0, 0x0

    iput-boolean v0, p0, Latakplugin/gotennaproag/sD0;->f:Z
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v0, p0, Latakplugin/gotennaproag/sD0;->f:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Latakplugin/gotennaproag/sD0;->b:Latakplugin/gotennaproag/eS;
    ...
    iget-object v2, p0, Latakplugin/gotennaproag/sD0;->a:Ljava/lang/Object;
    ...
    new-instance v3, Latakplugin/gotennaproag/Ra;

    iget-object v4, p0, Latakplugin/gotennaproag/sD0;->c:Ljava/lang/String;

    invoke-direct {v3, v4, v1, v2}, Latakplugin/gotennaproag/Ra;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Latakplugin/gotennaproag/wS;)V

    new-instance v1, Ljava/security/KeyPair;

    new-instance v4, Latakplugin/gotennaproag/Qa;

    iget-object v5, p0, Latakplugin/gotennaproag/sD0;->c:Ljava/lang/String;

    invoke-direct {v4, v5, v0, v3, v2}, Latakplugin/gotennaproag/Qa;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;Latakplugin/gotennaproag/Ra;Latakplugin/gotennaproag/wS;)V
    ...
    invoke-direct {v3, v4, v1}, Latakplugin/gotennaproag/Ra;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;)V

    new-instance v1, Latakplugin/gotennaproag/Qa;

    iget-object v4, p0, Latakplugin/gotennaproag/sD0;->c:Ljava/lang/String;

    invoke-direct {v1, v4, v0}, Latakplugin/gotennaproag/Qa;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;)V
    ...
    invoke-direct {v3, v4, v1, v2}, Latakplugin/gotennaproag/Ra;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Ljava/security/spec/ECParameterSpec;)V
    ...
    invoke-direct {v4, v5, v0, v3, v2}, Latakplugin/gotennaproag/Qa;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;Latakplugin/gotennaproag/Ra;Ljava/security/spec/ECParameterSpec;)V
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Latakplugin/gotennaproag/sD0;->e:Ljava/security/SecureRandom;

    iget-object p1, p0, Latakplugin/gotennaproag/sD0;->a:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Latakplugin/gotennaproag/sD0;->initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    :try_end_0
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/sD0;->a:Ljava/lang/Object;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/sD0;->d:Latakplugin/gotennaproag/dS;

    iget-object p2, p0, Latakplugin/gotennaproag/sD0;->b:Latakplugin/gotennaproag/eS;

    .line 7
    invoke-virtual {p2, p1}, Latakplugin/gotennaproag/eS;->a(Latakplugin/gotennaproag/jD0;)V

    iput-boolean v1, p0, Latakplugin/gotennaproag/sD0;->f:Z
    ...
    iput-object v3, p0, Latakplugin/gotennaproag/sD0;->d:Latakplugin/gotennaproag/dS;

    iget-object p1, p0, Latakplugin/gotennaproag/sD0;->b:Latakplugin/gotennaproag/eS;
    ...
    invoke-direct {p1, v4}, Latakplugin/gotennaproag/t0;-><init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/sD0;->a:Ljava/lang/Object;
