.class public Latakplugin/gotennaproag/DB1$b;
...
.method public constructor <init>(Ljava/util/stream/Stream;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/DB1$b;->a:Ljava/util/stream/Stream;
...
# virtual methods
.method public a(Latakplugin/gotennaproag/m30;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/DB1$b;->c()V

    invoke-virtual {p0}, Latakplugin/gotennaproag/DB1$b;->k()Ljava/util/stream/Stream;

    move-result-object v0

    invoke-static {p1}, Latakplugin/gotennaproag/q10;->H(Latakplugin/gotennaproag/m30;)Ljava/util/function/Predicate;
...
.method public b(Latakplugin/gotennaproag/m30;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected c()V
    ...
    iget-boolean v0, p0, Latakplugin/gotennaproag/DB1$b;->b:Z
...
.method public d(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/DB1$b;->h()V
...
.method public f(Latakplugin/gotennaproag/m30;)Latakplugin/gotennaproag/DB1$b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/DB1$b;->a:Ljava/util/stream/Stream;
...
.method public g(Latakplugin/gotennaproag/H10;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1}, Latakplugin/gotennaproag/q10;->F(Latakplugin/gotennaproag/H10;)Ljava/util/function/Consumer;
...
.method protected h()V
    ...
    iput-boolean v0, p0, Latakplugin/gotennaproag/DB1$b;->b:Z

    return-void
.end method

.method public i(Latakplugin/gotennaproag/i20;)Latakplugin/gotennaproag/DB1$b;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    iget-object v1, p0, Latakplugin/gotennaproag/DB1$b;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Latakplugin/gotennaproag/q10;->G(Latakplugin/gotennaproag/i20;)Ljava/util/function/Function;
    ...
    invoke-direct {v0, p1}, Latakplugin/gotennaproag/DB1$b;-><init>(Ljava/util/stream/Stream;)V
