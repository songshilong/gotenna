.class Latakplugin/gotennaproag/JV1;
...
.field private c:Latakplugin/gotennaproag/Ro;
...
# direct methods
.method protected constructor <init>(Latakplugin/gotennaproag/Sx0;Latakplugin/gotennaproag/Ro;)V
    .locals 2
    ...
    iput-boolean v0, p0, Latakplugin/gotennaproag/JV1;->s:Z

    iput-object p1, p0, Latakplugin/gotennaproag/JV1;->a:Latakplugin/gotennaproag/Sx0;

    iput-object p2, p0, Latakplugin/gotennaproag/JV1;->c:Latakplugin/gotennaproag/Ro;

    :try_start_0
    invoke-virtual {p2}, Latakplugin/gotennaproag/Ro;->J()Latakplugin/gotennaproag/l5;

    move-result-object p1

    invoke-static {p1}, Latakplugin/gotennaproag/nW1;->b(Latakplugin/gotennaproag/l5;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Latakplugin/gotennaproag/JV1;->e:Ljava/lang/String;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/JV1;->f:[B
    ...
    :goto_0
    invoke-static {p0}, Latakplugin/gotennaproag/JV1;->e(Ljava/security/cert/X509CRL;)Z

    move-result p1

    iput-boolean p1, p0, Latakplugin/gotennaproag/JV1;->i:Z
    :try_end_0
...
.method private c(Ljava/security/PublicKey;Ljava/security/Signature;)V
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/JV1;->c:Latakplugin/gotennaproag/Ro;

    invoke-virtual {v0}, Latakplugin/gotennaproag/Ro;->J()Latakplugin/gotennaproag/l5;

    move-result-object v0

    iget-object v1, p0, Latakplugin/gotennaproag/JV1;->c:Latakplugin/gotennaproag/Ro;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getTBSCertList()[B

    move-result-object p1

    invoke-virtual {p2, p1}, Ljava/security/Signature;->update([B)V

    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getSignature()[B
...
.method private d(Z)Ljava/util/Set;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getVersion()I
...
.method static e(Ljava/security/cert/X509CRL;)Z
    ...
    :goto_1
    new-instance v0, Latakplugin/gotennaproag/sZ;

    const-string v1, "Exception reading IssuingDistributionPoint"

    invoke-direct {v0, v1, p0}, Latakplugin/gotennaproag/sZ;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private g()Ljava/util/Set;
    ...
    new-instance v4, Latakplugin/gotennaproag/GV1;

    iget-boolean v5, p0, Latakplugin/gotennaproag/JV1;->i:Z

    invoke-direct {v4, v3, v5, v2}, Latakplugin/gotennaproag/GV1;-><init>(Latakplugin/gotennaproag/xD1$b;ZLatakplugin/gotennaproag/rV1;)V

    invoke-interface {v0, v4}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-boolean v4, p0, Latakplugin/gotennaproag/JV1;->i:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    instance-of v0, p1, Latakplugin/gotennaproag/JV1;

    if-eqz v0, :cond_3

    check-cast p1, Latakplugin/gotennaproag/JV1;

    iget-boolean v0, p0, Latakplugin/gotennaproag/JV1;->s:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p1, Latakplugin/gotennaproag/JV1;->s:Z

    if-eqz v0, :cond_2

    iget v0, p1, Latakplugin/gotennaproag/JV1;->v:I

    iget v2, p0, Latakplugin/gotennaproag/JV1;->v:I
    ...
    iget-object p1, p1, Latakplugin/gotennaproag/JV1;->c:Latakplugin/gotennaproag/Ro;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Latakplugin/gotennaproag/JV1;->d(Z)Ljava/util/Set;
...
.method public getRevokedCertificate(Ljava/math/BigInteger;)Ljava/security/cert/X509CRLEntry;
    ...
    new-instance p1, Latakplugin/gotennaproag/GV1;

    iget-boolean v0, p0, Latakplugin/gotennaproag/JV1;->i:Z

    invoke-direct {p1, v3, v0, v2}, Latakplugin/gotennaproag/GV1;-><init>(Latakplugin/gotennaproag/xD1$b;ZLatakplugin/gotennaproag/rV1;)V
...
.method public getRevokedCertificates()Ljava/util/Set;
    ...
    invoke-direct {p0}, Latakplugin/gotennaproag/JV1;->g()Ljava/util/Set;
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/JV1;->e:Ljava/lang/String;
...
.method public getSigAlgParams()[B
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/JV1;->f:[B
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    sget-object v1, Latakplugin/gotennaproag/KZ;->i1:Latakplugin/gotennaproag/t0;
...
.method public hashCode()I
    ...
    iput v0, p0, Latakplugin/gotennaproag/JV1;->v:I

    :cond_0
    iget v0, p0, Latakplugin/gotennaproag/JV1;->v:I
...
.method public isRevoked(Ljava/security/cert/Certificate;)Z
    ...
    iget-boolean v6, p0, Latakplugin/gotennaproag/JV1;->i:Z
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getIssuerDN()Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getThisUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getNextUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getSigAlgName()Ljava/lang/String;
    ...
    :cond_1
    iget-object v3, p0, Latakplugin/gotennaproag/JV1;->c:Latakplugin/gotennaproag/Ro;
    ...
    :cond_9
    invoke-virtual {p0}, Latakplugin/gotennaproag/JV1;->getRevokedCertificates()Ljava/util/Set;
...
.method public verify(Ljava/security/PublicKey;)V
    ...
    :try_start_0
    iget-object v0, p0, Latakplugin/gotennaproag/JV1;->a:Latakplugin/gotennaproag/Sx0;
    ...
    .line 3
    :goto_0
    invoke-direct {p0, p1, v0}, Latakplugin/gotennaproag/JV1;->c(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    .line 6
    :goto_0
    invoke-direct {p0, p1, p2}, Latakplugin/gotennaproag/JV1;->c(Ljava/security/PublicKey;Ljava/security/Signature;)V
