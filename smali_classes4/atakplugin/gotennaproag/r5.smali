.class public Latakplugin/gotennaproag/r5;
...
.method protected b(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Latakplugin/gotennaproag/r5;->a:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineGetEncoded()[B
    ...
    iget-object v1, p0, Latakplugin/gotennaproag/r5;->a:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v1}, Ljava/security/spec/DSAParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Latakplugin/gotennaproag/r5;->a:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v2}, Ljava/security/spec/DSAParameterSpec;->getQ()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, Latakplugin/gotennaproag/r5;->a:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v3}, Ljava/security/spec/DSAParameterSpec;->getG()Ljava/math/BigInteger;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3}, Latakplugin/gotennaproag/fE;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method protected engineGetEncoded(Ljava/lang/String;)[B
    ...
    .line 4
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/r5;->a(Ljava/lang/String;)Z
    ...
    .line 5
    invoke-virtual {p0}, Latakplugin/gotennaproag/r5;->engineGetEncoded()[B
...
.method protected engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/r5;->b(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/r5;->a:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineInit([B)V
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/r5;->a:Ljava/security/spec/DSAParameterSpec;
    :try_end_0
...
.method protected engineInit([BLjava/lang/String;)V
    ...
    .line 8
    invoke-virtual {p0, p2}, Latakplugin/gotennaproag/r5;->a(Ljava/lang/String;)Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/r5;->engineInit([B)V
