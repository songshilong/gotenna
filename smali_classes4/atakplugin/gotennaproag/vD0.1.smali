...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/vD0;->a:Ljava/lang/Object;

    new-instance v2, Latakplugin/gotennaproag/eS;

    invoke-direct {v2}, Latakplugin/gotennaproag/eS;-><init>()V

    iput-object v2, p0, Latakplugin/gotennaproag/vD0;->b:Latakplugin/gotennaproag/eS;

    iput-object v0, p0, Latakplugin/gotennaproag/vD0;->c:Ljava/lang/String;

    const/16 v0, 0xef

    iput v0, p0, Latakplugin/gotennaproag/vD0;->e:I

    iput-object v1, p0, Latakplugin/gotennaproag/vD0;->f:Ljava/security/SecureRandom;

    const/4 v0, 0x0

    iput-boolean v0, p0, Latakplugin/gotennaproag/vD0;->g:Z
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v0, p0, Latakplugin/gotennaproag/vD0;->g:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Latakplugin/gotennaproag/vD0;->b:Latakplugin/gotennaproag/eS;
    ...
    iget-object v2, p0, Latakplugin/gotennaproag/vD0;->a:Ljava/lang/Object;
    ...
    new-instance v3, Latakplugin/gotennaproag/Va;

    iget-object v4, p0, Latakplugin/gotennaproag/vD0;->c:Ljava/lang/String;

    invoke-direct {v3, v4, v1, v2}, Latakplugin/gotennaproag/Va;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Latakplugin/gotennaproag/wS;)V

    new-instance v1, Ljava/security/KeyPair;

    new-instance v4, Latakplugin/gotennaproag/Ua;

    iget-object v5, p0, Latakplugin/gotennaproag/vD0;->c:Ljava/lang/String;

    invoke-direct {v4, v5, v0, v3, v2}, Latakplugin/gotennaproag/Ua;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;Latakplugin/gotennaproag/Va;Latakplugin/gotennaproag/wS;)V
    ...
    invoke-direct {v3, v4, v1}, Latakplugin/gotennaproag/Va;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;)V

    new-instance v1, Latakplugin/gotennaproag/Ua;

    iget-object v4, p0, Latakplugin/gotennaproag/vD0;->c:Ljava/lang/String;

    invoke-direct {v1, v4, v0}, Latakplugin/gotennaproag/Ua;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;)V
    ...
    invoke-direct {v3, v4, v1, v2}, Latakplugin/gotennaproag/Va;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Ljava/security/spec/ECParameterSpec;)V
    ...
    invoke-direct {v4, v5, v0, v3, v2}, Latakplugin/gotennaproag/Ua;-><init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;Latakplugin/gotennaproag/Va;Ljava/security/spec/ECParameterSpec;)V
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    iput p1, p0, Latakplugin/gotennaproag/vD0;->e:I

    iput-object p2, p0, Latakplugin/gotennaproag/vD0;->f:Ljava/security/SecureRandom;

    iget-object p1, p0, Latakplugin/gotennaproag/vD0;->a:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Latakplugin/gotennaproag/vD0;->initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    :try_end_0
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/vD0;->a:Ljava/lang/Object;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/vD0;->d:Latakplugin/gotennaproag/dS;

    iget-object p2, p0, Latakplugin/gotennaproag/vD0;->b:Latakplugin/gotennaproag/eS;

    .line 7
    invoke-virtual {p2, p1}, Latakplugin/gotennaproag/eS;->a(Latakplugin/gotennaproag/jD0;)V

    iput-boolean v1, p0, Latakplugin/gotennaproag/vD0;->g:Z
    ...
    iput-object v3, p0, Latakplugin/gotennaproag/vD0;->d:Latakplugin/gotennaproag/dS;

    iget-object p1, p0, Latakplugin/gotennaproag/vD0;->b:Latakplugin/gotennaproag/eS;
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/vD0;->a:Ljava/lang/Object;
