...
.field private transient i:Latakplugin/gotennaproag/uE;
...
.method public constructor <init>(Latakplugin/gotennaproag/KS;Latakplugin/gotennaproag/gc1;)V
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Ra;->a:Ljava/lang/String;
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;

    :goto_0
    return-void
.end method

.method public constructor <init>(Latakplugin/gotennaproag/Ra;)V
    .locals 1
    ...
    .line 2
    iget-object v0, p1, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;

    iput-object v0, p0, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;

    .line 3
    iget-object v0, p1, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;

    iput-object v0, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;

    .line 4
    iget-boolean v0, p1, Latakplugin/gotennaproag/Ra;->c:Z

    iput-boolean v0, p0, Latakplugin/gotennaproag/Ra;->c:Z

    .line 5
    iget-object p1, p1, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;

    iput-object p1, p0, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;
...
.method constructor <init>(Latakplugin/gotennaproag/zC1;)V
    ...
    .line 30
    invoke-direct {p0, p1}, Latakplugin/gotennaproag/Ra;->f(Latakplugin/gotennaproag/zC1;)V
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Ra;->a:Ljava/lang/String;

    iput-object p2, p0, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Latakplugin/gotennaproag/wS;)V
    ...
    .line 25
    invoke-direct {p0, p1, v0}, Latakplugin/gotennaproag/Ra;->b(Ljava/security/spec/EllipticCurve;Latakplugin/gotennaproag/KR;)Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Ljava/security/spec/ECParameterSpec;)V
    ...
    :cond_0
    iput-object p3, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/security/spec/ECPublicKeySpec;)V
    ...
    invoke-static {v0, p1, v2}, Latakplugin/gotennaproag/sR;->e(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;Z)Latakplugin/gotennaproag/xS;

    move-result-object p1

    const/4 v0, 0x0

    iget-object v2, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;

    invoke-static {v0, v2}, Latakplugin/gotennaproag/sR;->k(Latakplugin/gotennaproag/gc1;Ljava/security/spec/ECParameterSpec;)Latakplugin/gotennaproag/KR;
...
.method private f(Latakplugin/gotennaproag/zC1;)V
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/Ra;->a:Ljava/lang/String;
    ...
    sget-object v2, Latakplugin/gotennaproag/xM1;->b:Latakplugin/gotennaproag/t0;
    ...
    invoke-direct {p0, v0}, Latakplugin/gotennaproag/Ra;->h([B)V
    ...
    invoke-static {v1}, Latakplugin/gotennaproag/uE;->F(Ljava/lang/Object;)Latakplugin/gotennaproag/uE;

    move-result-object v1

    iput-object v1, p0, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;

    invoke-virtual {v1}, Latakplugin/gotennaproag/uE;->H()Z

    move-result v1

    if-eqz v1, :cond_1

    iget-object p1, p0, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;

    invoke-virtual {p1}, Latakplugin/gotennaproag/uE;->G()Latakplugin/gotennaproag/t0;

    move-result-object p1

    invoke-static {p1}, Latakplugin/gotennaproag/tE;->a(Latakplugin/gotennaproag/t0;)Latakplugin/gotennaproag/KR;

    move-result-object v1

    new-instance v9, Latakplugin/gotennaproag/mS;
    ...
    :cond_1
    iget-object v1, p0, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;

    invoke-virtual {v1}, Latakplugin/gotennaproag/uE;->E()Latakplugin/gotennaproag/rE;

    move-result-object v1

    invoke-virtual {v1}, Latakplugin/gotennaproag/rE;->D()[B
    ...
    invoke-virtual {v4, v2}, Latakplugin/gotennaproag/y0;->equals(Ljava/lang/Object;)Z

    move-result v4

    if-eqz v4, :cond_2

    invoke-direct {p0, v3}, Latakplugin/gotennaproag/Ra;->h([B)V

    :cond_2
    invoke-virtual {v1}, Latakplugin/gotennaproag/rE;->E()Latakplugin/gotennaproag/qE;

    move-result-object v4

    new-instance v12, Latakplugin/gotennaproag/yR$d;

    invoke-virtual {v4}, Latakplugin/gotennaproag/qE;->G()I

    move-result v6

    invoke-virtual {v4}, Latakplugin/gotennaproag/qE;->D()I

    move-result v7

    invoke-virtual {v4}, Latakplugin/gotennaproag/qE;->E()I

    move-result v8

    invoke-virtual {v4}, Latakplugin/gotennaproag/qE;->F()I

    move-result v9

    invoke-virtual {v1}, Latakplugin/gotennaproag/rE;->C()Ljava/math/BigInteger;
    ...
    invoke-direct/range {v5 .. v11}, Latakplugin/gotennaproag/yR$d;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-virtual {v1}, Latakplugin/gotennaproag/rE;->F()[B
    ...
    :cond_3
    new-instance v9, Latakplugin/gotennaproag/wS;

    invoke-static {v12, v3}, Latakplugin/gotennaproag/vE;->a(Latakplugin/gotennaproag/yR;[B)Latakplugin/gotennaproag/xS;

    move-result-object p1

    invoke-virtual {v1}, Latakplugin/gotennaproag/rE;->H()Ljava/math/BigInteger;

    move-result-object v1

    invoke-direct {v9, v12, p1, v1}, Latakplugin/gotennaproag/wS;-><init>(Latakplugin/gotennaproag/yR;Latakplugin/gotennaproag/xS;Ljava/math/BigInteger;)V

    :goto_0
    invoke-virtual {v9}, Latakplugin/gotennaproag/wS;->a()Latakplugin/gotennaproag/yR;

    move-result-object p1

    invoke-virtual {v9}, Latakplugin/gotennaproag/wS;->e()[B
    ...
    iget-object v2, p0, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;

    invoke-virtual {v2}, Latakplugin/gotennaproag/uE;->G()Latakplugin/gotennaproag/t0;
    ...
    invoke-virtual {v9}, Latakplugin/gotennaproag/wS;->b()Latakplugin/gotennaproag/xS;
    ...
    invoke-virtual {v6}, Latakplugin/gotennaproag/xS;->g()Latakplugin/gotennaproag/QR;

    move-result-object v6

    invoke-virtual {v6}, Latakplugin/gotennaproag/QR;->v()Ljava/math/BigInteger;

    move-result-object v6

    invoke-direct {v5, v2, v6}, Ljava/security/spec/ECPoint;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-virtual {v9}, Latakplugin/gotennaproag/wS;->d()Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {v9}, Latakplugin/gotennaproag/wS;->c()Ljava/math/BigInteger;
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-static {p1, v0}, Latakplugin/gotennaproag/vE;->a(Latakplugin/gotennaproag/yR;[B)Latakplugin/gotennaproag/xS;
...
.method private i(Ljava/io/ObjectOutputStream;)V
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Ra;->getEncoded()[B
...
.method public F()Latakplugin/gotennaproag/xS;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;

    invoke-virtual {v0}, Latakplugin/gotennaproag/JS;->c()Latakplugin/gotennaproag/xS;

    move-result-object v0

    iget-object v1, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;
...
.method d()Latakplugin/gotennaproag/wS;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Ra;->f:Ljava/security/spec/ECParameterSpec;
...
.method public e()[B
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Ra;->i:Latakplugin/gotennaproag/uE;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Latakplugin/gotennaproag/uE;->C()[B
    ...
    :cond_0
    invoke-static {}, Latakplugin/gotennaproag/uE;->D()[B
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Ra;->d()Latakplugin/gotennaproag/wS;

    move-result-object v0

    invoke-virtual {p1}, Latakplugin/gotennaproag/Ra;->d()Latakplugin/gotennaproag/wS;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Ra;->a:Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    invoke-direct {v0, v1}, Latakplugin/gotennaproag/uE;-><init>(Latakplugin/gotennaproag/t0;)V
    ...
    iget-boolean v3, p0, Latakplugin/gotennaproag/Ra;->c:Z
    ...
    :goto_0
    iget-object v1, p0, Latakplugin/gotennaproag/Ra;->e:Latakplugin/gotennaproag/JS;

    invoke-virtual {v1}, Latakplugin/gotennaproag/JS;->c()Latakplugin/gotennaproag/xS;

    move-result-object v1

    invoke-static {v1}, Latakplugin/gotennaproag/vE;->b(Latakplugin/gotennaproag/xS;)[B
    ...
    sget-object v4, Latakplugin/gotennaproag/xM1;->c:Latakplugin/gotennaproag/t0;
