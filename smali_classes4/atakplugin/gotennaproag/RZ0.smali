...
.method public constructor <init>(Latakplugin/gotennaproag/cg;)V
    ...
    instance-of v0, p1, Latakplugin/gotennaproag/dZ0;

    if-nez v0, :cond_0

    instance-of v0, p1, Latakplugin/gotennaproag/gk;
    ...
    iput p1, p0, Latakplugin/gotennaproag/RZ0;->g:I
...
.method public a([BI)I
    ...
    iget-boolean v3, p0, Latakplugin/gotennaproag/Lh;->c:Z
    ...
    invoke-interface {v3, v5, v4, v2, v4}, Latakplugin/gotennaproag/cg;->f([BI[BI)I
    ...
    instance-of v5, v3, Latakplugin/gotennaproag/Uj;

    if-eqz v5, :cond_2

    check-cast v3, Latakplugin/gotennaproag/Uj;

    invoke-virtual {v3}, Latakplugin/gotennaproag/Uj;->g()Latakplugin/gotennaproag/cg;

    move-result-object v3

    iget-object v5, p0, Latakplugin/gotennaproag/Lh;->a:[B

    invoke-interface {v3, v5, v0, p1, p2}, Latakplugin/gotennaproag/cg;->f([BI[BI)I
    ...
    iget-object v5, p0, Latakplugin/gotennaproag/Lh;->d:Latakplugin/gotennaproag/cg;

    instance-of v6, v5, Latakplugin/gotennaproag/Uj;

    if-eqz v6, :cond_5

    check-cast v5, Latakplugin/gotennaproag/Uj;

    invoke-virtual {v5}, Latakplugin/gotennaproag/Uj;->g()Latakplugin/gotennaproag/cg;

    move-result-object v5

    iget-object v6, p0, Latakplugin/gotennaproag/Lh;->a:[B

    invoke-interface {v5, v6, v4, v2, v4}, Latakplugin/gotennaproag/cg;->f([BI[BI)I
    ...
    invoke-interface {v5, v2, v4, p1, p2}, Latakplugin/gotennaproag/cg;->f([BI[BI)I
...
.method public h([BII[BI)I
    ...
    invoke-virtual {p0, p3}, Latakplugin/gotennaproag/RZ0;->e(I)I
