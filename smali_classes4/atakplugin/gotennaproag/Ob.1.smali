...
.super Latakplugin/gotennaproag/Rb;
.source "SourceFile"
...
.method public constructor <init>(Latakplugin/gotennaproag/i0;)V
    ...
    invoke-direct {p0, p1}, Latakplugin/gotennaproag/Ob;-><init>(Latakplugin/gotennaproag/y0;)V
...
.method public constructor <init>(Latakplugin/gotennaproag/y0;)V
    ...
    .line 3
    invoke-static {p1}, Latakplugin/gotennaproag/Ob;->S(Latakplugin/gotennaproag/y0;)[B

    move-result-object p1

    invoke-direct {p0, p1}, Latakplugin/gotennaproag/Rb;-><init>([B)V
...
.method public constructor <init>(Ljava/util/Vector;)V
    ...
    .line 2
    invoke-static {p1}, Latakplugin/gotennaproag/Ob;->T(Ljava/util/Vector;)[B

    move-result-object v0

    invoke-direct {p0, v0}, Latakplugin/gotennaproag/Rb;-><init>([B)V

    iput-object p1, p0, Latakplugin/gotennaproag/Ob;->f:Ljava/util/Vector;
...
.method public static O(Latakplugin/gotennaproag/z0;)Latakplugin/gotennaproag/Rb;
    .locals 2
    ...
    :cond_0
    new-instance p0, Latakplugin/gotennaproag/Ob;

    invoke-direct {p0, v0}, Latakplugin/gotennaproag/Ob;-><init>(Ljava/util/Vector;)V
...
.method private static S(Latakplugin/gotennaproag/y0;)[B
    .locals 1
...
.method private static T(Ljava/util/Vector;)[B
    .locals 3
...
.method public Q()Ljava/util/Enumeration;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Ob;->f:Ljava/util/Vector;

    if-nez v0, :cond_0

    invoke-direct {p0}, Latakplugin/gotennaproag/Ob;->P()Ljava/util/Vector;
