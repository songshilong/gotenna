.class public Latakplugin/gotennaproag/Sa;
...
.field private transient e:Latakplugin/gotennaproag/i0;
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->v:Latakplugin/gotennaproag/O21;
...
.method public constructor <init>(Latakplugin/gotennaproag/GS;)V
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->f:Ljava/math/BigInteger;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Latakplugin/gotennaproag/Sa;)V
    .locals 1
    ...
    .line 21
    iget-object v0, p1, Latakplugin/gotennaproag/Sa;->f:Ljava/math/BigInteger;

    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->f:Ljava/math/BigInteger;

    .line 22
    iget-object v0, p1, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;

    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;

    .line 23
    iget-boolean v0, p1, Latakplugin/gotennaproag/Sa;->c:Z

    iput-boolean v0, p0, Latakplugin/gotennaproag/Sa;->c:Z

    .line 24
    iget-object v0, p1, Latakplugin/gotennaproag/Sa;->v:Latakplugin/gotennaproag/O21;

    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->v:Latakplugin/gotennaproag/O21;

    .line 25
    iget-object v0, p1, Latakplugin/gotennaproag/Sa;->s:Latakplugin/gotennaproag/qC;

    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->s:Latakplugin/gotennaproag/qC;

    .line 26
    iget-object p1, p1, Latakplugin/gotennaproag/Sa;->e:Latakplugin/gotennaproag/i0;

    iput-object p1, p0, Latakplugin/gotennaproag/Sa;->e:Latakplugin/gotennaproag/i0;
...
.method constructor <init>(Latakplugin/gotennaproag/ha1;)V
    ...
    .line 62
    invoke-direct {p0, p1}, Latakplugin/gotennaproag/Sa;->h(Latakplugin/gotennaproag/ha1;)V
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Sa;->a:Ljava/lang/String;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Sa;->f:Ljava/math/BigInteger;
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;Latakplugin/gotennaproag/Ta;Latakplugin/gotennaproag/wS;)V
    .locals 3
    ...
    iput-object p2, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;
    ...
    .line 55
    :goto_0
    invoke-virtual {p3}, Latakplugin/gotennaproag/Ta;->f()Latakplugin/gotennaproag/i0;
    ...
    .line 56
    invoke-direct {p0, p3}, Latakplugin/gotennaproag/Sa;->g(Latakplugin/gotennaproag/Ta;)Latakplugin/gotennaproag/qC;

    move-result-object p1

    iput-object p1, p0, Latakplugin/gotennaproag/Sa;->s:Latakplugin/gotennaproag/qC;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/FS;Latakplugin/gotennaproag/Ta;Ljava/security/spec/ECParameterSpec;)V
    .locals 3
    ...
    :cond_0
    iput-object p4, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;
...
.method private f([BILjava/math/BigInteger;)V
    .locals 5
...
.method private g(Latakplugin/gotennaproag/Ta;)Latakplugin/gotennaproag/qC;
    .locals 0

    :try_start_0
    invoke-virtual {p1}, Latakplugin/gotennaproag/Ta;->getEncoded()[B
...
.method private h(Latakplugin/gotennaproag/ha1;)V
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Sa;->e:Latakplugin/gotennaproag/i0;
    ...
    invoke-static {v1}, Latakplugin/gotennaproag/VR;->b(Ljava/lang/String;)Latakplugin/gotennaproag/mS;

    move-result-object v1

    invoke-virtual {v1}, Latakplugin/gotennaproag/wS;->a()Latakplugin/gotennaproag/yR;
    ...
    invoke-virtual {v1}, Latakplugin/gotennaproag/wS;->b()Latakplugin/gotennaproag/xS;
    ...
    invoke-virtual {v1}, Latakplugin/gotennaproag/wS;->d()Ljava/math/BigInteger;
    ...
    iput-object v2, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;
...
.method private i(Ljava/io/ObjectInputStream;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Sa;->v:Latakplugin/gotennaproag/O21;
...
.method private j(Ljava/io/ObjectOutputStream;)V
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Sa;->getEncoded()[B
...
.method public C()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Sa;->f:Ljava/math/BigInteger;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Latakplugin/gotennaproag/Sa;->c:Z
...
.method b()Latakplugin/gotennaproag/wS;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;

    if-eqz v0, :cond_0

    iget-boolean v1, p0, Latakplugin/gotennaproag/Sa;->c:Z
...
.method public c(Latakplugin/gotennaproag/t0;)Latakplugin/gotennaproag/i0;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Sa;->v:Latakplugin/gotennaproag/O21;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Latakplugin/gotennaproag/Sa;
    ...
    :cond_0
    check-cast p1, Latakplugin/gotennaproag/Sa;

    invoke-virtual {p0}, Latakplugin/gotennaproag/Sa;->C()Ljava/math/BigInteger;

    move-result-object v0

    invoke-virtual {p1}, Latakplugin/gotennaproag/Sa;->C()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Sa;->b()Latakplugin/gotennaproag/wS;

    move-result-object v0

    invoke-virtual {p1}, Latakplugin/gotennaproag/Sa;->b()Latakplugin/gotennaproag/wS;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Sa;->a:Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Sa;->e:Latakplugin/gotennaproag/i0;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Sa;->getS()Ljava/math/BigInteger;

    move-result-object v4

    invoke-direct {p0, v0, v3, v4}, Latakplugin/gotennaproag/Sa;->f([BILjava/math/BigInteger;)V
    ...
    sget-object v5, Latakplugin/gotennaproag/EB;->m:Latakplugin/gotennaproag/t0;

    iget-object v6, p0, Latakplugin/gotennaproag/Sa;->e:Latakplugin/gotennaproag/i0;
    ...
    invoke-direct {v5, v0}, Latakplugin/gotennaproag/IC;-><init>([B)V

    invoke-direct {v3, v4, v5}, Latakplugin/gotennaproag/ha1;-><init>(Latakplugin/gotennaproag/l5;Latakplugin/gotennaproag/i0;)V

    invoke-virtual {v3, v1}, Latakplugin/gotennaproag/s0;->t(Ljava/lang/String;)[B
    ...
    instance-of v3, v0, Latakplugin/gotennaproag/nS;
    ...
    iget-object v3, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;

    check-cast v3, Latakplugin/gotennaproag/nS;

    invoke-virtual {v3}, Latakplugin/gotennaproag/nS;->d()Ljava/lang/String;

    move-result-object v3

    invoke-direct {v0, v3}, Latakplugin/gotennaproag/t0;-><init>(Ljava/lang/String;)V

    :cond_1
    new-instance v3, Latakplugin/gotennaproag/SW1;

    invoke-direct {v3, v0}, Latakplugin/gotennaproag/SW1;-><init>(Latakplugin/gotennaproag/t0;)V

    sget-object v0, Latakplugin/gotennaproag/Zg;->e:Latakplugin/gotennaproag/gc1;

    iget-object v4, p0, Latakplugin/gotennaproag/Sa;->i:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-static {v0, v4, v5}, Latakplugin/gotennaproag/LS;->m(Latakplugin/gotennaproag/gc1;Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    ...
    invoke-direct {v3, v0}, Latakplugin/gotennaproag/SW1;-><init>(Latakplugin/gotennaproag/r0;)V
    ...
    invoke-static {v0, v2, v4}, Latakplugin/gotennaproag/LS;->m(Latakplugin/gotennaproag/gc1;Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    ...
    iget-boolean v5, p0, Latakplugin/gotennaproag/Sa;->c:Z

    invoke-static {v4, v3, v5}, Latakplugin/gotennaproag/sR;->d(Latakplugin/gotennaproag/yR;Ljava/security/spec/ECPoint;Z)Latakplugin/gotennaproag/xS;
    ...
    invoke-direct {v3, v0}, Latakplugin/gotennaproag/SW1;-><init>(Latakplugin/gotennaproag/UW1;)V
    ...
    :goto_0
    iget-object v4, p0, Latakplugin/gotennaproag/Sa;->s:Latakplugin/gotennaproag/qC;
    ...
    iget-object v6, p0, Latakplugin/gotennaproag/Sa;->s:Latakplugin/gotennaproag/qC;

    invoke-direct {v4, v0, v5, v6, v3}, Latakplugin/gotennaproag/ES;-><init>(ILjava/math/BigInteger;Latakplugin/gotennaproag/qC;Latakplugin/gotennaproag/i0;)V
    ...
    invoke-direct {v4, v0, v5, v3}, Latakplugin/gotennaproag/ES;-><init>(ILjava/math/BigInteger;Latakplugin/gotennaproag/i0;)V
    ...
    sget-object v6, Latakplugin/gotennaproag/EB;->m:Latakplugin/gotennaproag/t0;

    invoke-virtual {v3}, Latakplugin/gotennaproag/SW1;->h()Latakplugin/gotennaproag/y0;

    move-result-object v3

    invoke-direct {v5, v6, v3}, Latakplugin/gotennaproag/l5;-><init>(Latakplugin/gotennaproag/t0;Latakplugin/gotennaproag/i0;)V

    invoke-virtual {v4}, Latakplugin/gotennaproag/ES;->h()Latakplugin/gotennaproag/y0;

    move-result-object v3

    invoke-direct {v0, v5, v3}, Latakplugin/gotennaproag/ha1;-><init>(Latakplugin/gotennaproag/l5;Latakplugin/gotennaproag/i0;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Latakplugin/gotennaproag/Sa;->f:Ljava/math/BigInteger;
