.class final Latakplugin/gotennaproag/Tx0$b;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Latakplugin/gotennaproag/Tx0;->b(Ljava/util/Set;[Ljava/security/cert/CRL;)[Ljavax/net/ssl/X509TrustManager;
.end annotation
...
.field final synthetic b:[Ljava/security/cert/CRL;
...
.method constructor <init>(Ljava/util/Set;[Ljava/security/cert/CRL;[Ljava/security/cert/X509Certificate;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Tx0$b;->a:Ljava/util/Set;

    iput-object p2, p0, Latakplugin/gotennaproag/Tx0$b;->b:[Ljava/security/cert/CRL;

    iput-object p3, p0, Latakplugin/gotennaproag/Tx0$b;->c:[Ljava/security/cert/X509Certificate;
...
.method public checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Latakplugin/gotennaproag/Tx0$b;->a:Ljava/util/Set;
    ...
    iget-object v1, p0, Latakplugin/gotennaproag/Tx0$b;->b:[Ljava/security/cert/CRL;
    ...
    iget-object v2, p0, Latakplugin/gotennaproag/Tx0$b;->b:[Ljava/security/cert/CRL;
    ...
    invoke-static {p1}, Latakplugin/gotennaproag/Tx0;->d(Ljava/security/cert/X509Certificate;)V
    :try_end_0
...
.method public getAcceptedIssuers()[Ljava/security/cert/X509Certificate;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Tx0$b;->c:[Ljava/security/cert/X509Certificate;
