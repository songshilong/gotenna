...
.field private transient i:Latakplugin/gotennaproag/ze0;
...
.method public constructor <init>(Latakplugin/gotennaproag/KS;Latakplugin/gotennaproag/gc1;)V
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Va;->a:Ljava/lang/String;
    ...
    iput-object v1, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;

    :goto_0
    return-void
.end method

.method public constructor <init>(Latakplugin/gotennaproag/Va;)V
    .locals 1
    ...
    .line 2
    iget-object v0, p1, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;

    iput-object v0, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;

    .line 3
    iget-object v0, p1, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;

    iput-object v0, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;

    .line 4
    iget-boolean v0, p1, Latakplugin/gotennaproag/Va;->c:Z

    iput-boolean v0, p0, Latakplugin/gotennaproag/Va;->c:Z

    .line 5
    iget-object p1, p1, Latakplugin/gotennaproag/Va;->i:Latakplugin/gotennaproag/ze0;

    iput-object p1, p0, Latakplugin/gotennaproag/Va;->i:Latakplugin/gotennaproag/ze0;
...
.method constructor <init>(Latakplugin/gotennaproag/zC1;)V
    ...
    .line 34
    invoke-direct {p0, p1}, Latakplugin/gotennaproag/Va;->g(Latakplugin/gotennaproag/zC1;)V
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;)V
    ...
    iput-object p1, p0, Latakplugin/gotennaproag/Va;->a:Ljava/lang/String;

    iput-object p2, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Latakplugin/gotennaproag/wS;)V
    ...
    .line 25
    invoke-direct {p0, p1, v0}, Latakplugin/gotennaproag/Va;->b(Ljava/security/spec/EllipticCurve;Latakplugin/gotennaproag/KR;)Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Ljava/lang/String;Latakplugin/gotennaproag/JS;Ljava/security/spec/ECParameterSpec;)V
    ...
    :cond_0
    iput-object p3, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;
...
.method private g(Latakplugin/gotennaproag/zC1;)V
    ...
    iput-object v2, p0, Latakplugin/gotennaproag/Va;->a:Ljava/lang/String;
    ...
    sget-object v2, Latakplugin/gotennaproag/rl1;->h:Latakplugin/gotennaproag/t0;
    ...
    invoke-virtual {v0, v2, v3}, Latakplugin/gotennaproag/yR;->g(Ljava/math/BigInteger;Ljava/math/BigInteger;)Latakplugin/gotennaproag/xS;

    move-result-object v0

    const/4 v2, 0x0

    invoke-static {v2, p1}, Latakplugin/gotennaproag/LS;->g(Latakplugin/gotennaproag/gc1;Latakplugin/gotennaproag/wS;)Latakplugin/gotennaproag/KR;

    move-result-object v2

    invoke-direct {v1, v0, v2}, Latakplugin/gotennaproag/JS;-><init>(Latakplugin/gotennaproag/xS;Latakplugin/gotennaproag/KR;)V

    iput-object v1, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;

    new-instance v0, Latakplugin/gotennaproag/nS;

    iget-object v1, p0, Latakplugin/gotennaproag/Va;->i:Latakplugin/gotennaproag/ze0;
...
.method private i(Ljava/io/ObjectOutputStream;)V
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Va;->getEncoded()[B
...
.method public F()Latakplugin/gotennaproag/xS;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;

    if-nez v0, :cond_0

    iget-object v0, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Latakplugin/gotennaproag/Va;->c:Z
...
.method d()Latakplugin/gotennaproag/wS;
    ...
    iget-boolean v1, p0, Latakplugin/gotennaproag/Va;->c:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Latakplugin/gotennaproag/Va;
    ...
    :cond_0
    check-cast p1, Latakplugin/gotennaproag/Va;
    ...
    iget-object v2, p1, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/Va;->d()Latakplugin/gotennaproag/wS;

    move-result-object v0

    invoke-virtual {p1}, Latakplugin/gotennaproag/Va;->d()Latakplugin/gotennaproag/wS;
...
.method public f()Latakplugin/gotennaproag/ze0;
    .locals 1

    iget-object v0, p0, Latakplugin/gotennaproag/Va;->i:Latakplugin/gotennaproag/ze0;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/Va;->a:Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    iget-object v1, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;
    ...
    :goto_0
    iget-object v3, p0, Latakplugin/gotennaproag/Va;->i:Latakplugin/gotennaproag/ze0;
    ...
    :cond_1
    iget-object v3, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;

    instance-of v5, v3, Latakplugin/gotennaproag/nS;

    if-eqz v5, :cond_3

    if-eqz v2, :cond_2

    new-instance v5, Latakplugin/gotennaproag/ze0;
    ...
    invoke-static {v3}, Latakplugin/gotennaproag/WR;->e(Ljava/lang/String;)Latakplugin/gotennaproag/t0;

    move-result-object v3

    sget-object v6, Latakplugin/gotennaproag/rl1;->h:Latakplugin/gotennaproag/t0;

    invoke-direct {v5, v3, v6}, Latakplugin/gotennaproag/ze0;-><init>(Latakplugin/gotennaproag/t0;Latakplugin/gotennaproag/t0;)V
    ...
    sget-object v6, Latakplugin/gotennaproag/rl1;->g:Latakplugin/gotennaproag/t0;
    ...
    invoke-static {v3}, Latakplugin/gotennaproag/sR;->a(Ljava/security/spec/EllipticCurve;)Latakplugin/gotennaproag/yR;

    move-result-object v6

    new-instance v3, Latakplugin/gotennaproag/UW1;

    iget-object v5, p0, Latakplugin/gotennaproag/Va;->f:Ljava/security/spec/ECParameterSpec;

    invoke-virtual {v5}, Ljava/security/spec/ECParameterSpec;->getGenerator()Ljava/security/spec/ECPoint;

    move-result-object v5

    iget-boolean v7, p0, Latakplugin/gotennaproag/Va;->c:Z

    invoke-static {v6, v5, v7}, Latakplugin/gotennaproag/sR;->d(Latakplugin/gotennaproag/yR;Ljava/security/spec/ECPoint;Z)Latakplugin/gotennaproag/xS;
    ...
    invoke-direct/range {v5 .. v10}, Latakplugin/gotennaproag/UW1;-><init>(Latakplugin/gotennaproag/yR;Latakplugin/gotennaproag/xS;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    new-instance v5, Latakplugin/gotennaproag/SW1;

    invoke-direct {v5, v3}, Latakplugin/gotennaproag/SW1;-><init>(Latakplugin/gotennaproag/UW1;)V
    ...
    :cond_4
    sget-object v2, Latakplugin/gotennaproag/rl1;->g:Latakplugin/gotennaproag/t0;
    ...
    invoke-direct {p0, v7, v5, v4, v0}, Latakplugin/gotennaproag/Va;->e([BIILjava/math/BigInteger;)V

    invoke-direct {p0, v7, v5, v6, v1}, Latakplugin/gotennaproag/Va;->e([BIILjava/math/BigInteger;)V
    ...
    invoke-direct {v2, v7}, Latakplugin/gotennaproag/IC;-><init>([B)V
...
.method public getW()Ljava/security/spec/ECPoint;
    ...
    iget-object v2, p0, Latakplugin/gotennaproag/Va;->e:Latakplugin/gotennaproag/JS;
