...
.method public static b(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {v1}, Landroid/support/v4/media/session/b$a;->e0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
...
.method public static e(Ljava/lang/Object;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->t(Ljava/lang/Object;Landroid/support/v4/media/session/b;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public static t(Ljava/lang/Object;Landroid/support/v4/media/session/b;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    .locals 1
    .annotation build Landroidx/annotation/RestrictTo;
        value = {
            .enum Landroidx/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroidx/annotation/RestrictTo$Scope;
...
.method public u()Landroid/support/v4/media/session/b;
    .locals 1
    .annotation build Landroidx/annotation/RestrictTo;
        value = {
            .enum Landroidx/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroidx/annotation/RestrictTo$Scope;
...
.method public v()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->e:Landroid/os/Bundle;
...
.method public x(Landroid/support/v4/media/session/b;)V
    .locals 0
    .annotation build Landroidx/annotation/RestrictTo;
        value = {
            .enum Landroidx/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroidx/annotation/RestrictTo$Scope;
...
.method public z()Landroid/os/Bundle;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->e:Landroid/os/Bundle;
