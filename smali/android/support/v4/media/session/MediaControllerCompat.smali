...
.method public A(I)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->t()Landroid/support/v4/media/MediaDescriptionCompat;
...
.method public B(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/media/session/MediaControllerCompat$c;->h(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public E(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->d(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    :try_end_0
...
.method public a(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->j(Landroid/support/v4/media/MediaDescriptionCompat;)V
...
.method public b(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->e(Landroid/support/v4/media/MediaDescriptionCompat;I)V
...
.method public d(Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->p(Landroid/view/KeyEvent;)Z
...
.method public h()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->u()Ljava/lang/Object;
...
.method public i()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->m()Landroid/support/v4/media/MediaMetadataCompat;
...
.method public m()Ljava/util/List;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->q()Ljava/util/List;
...
.method public n()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->l()Ljava/lang/CharSequence;
...
.method public o()I
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->c()I
...
.method public s()Landroid/os/Bundle;
    ...
    invoke-virtual {v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->v()Landroid/os/Bundle;
...
.method public v()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->g()Z
...
.method public y(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->v(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
...
.method public z(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->i(Landroid/support/v4/media/MediaDescriptionCompat;)V
