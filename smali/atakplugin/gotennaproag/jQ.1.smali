.class public final Latakplugin/gotennaproag/jQ;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Latakplugin/gotennaproag/jQ$a;,
        Latakplugin/gotennaproag/jQ$b;
    }
.end annotation
...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, v0, v0}, Latakplugin/gotennaproag/jQ;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, Latakplugin/gotennaproag/jQ;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {p0, p1}, Latakplugin/gotennaproag/jQ;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
...
.method public static c(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, Latakplugin/gotennaproag/jQ;->e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
...
.method public static g(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, Latakplugin/gotennaproag/cQ;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Latakplugin/gotennaproag/eQ;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, Latakplugin/gotennaproag/gQ;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static l(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    invoke-static {p0, p1}, Latakplugin/gotennaproag/jQ$b;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Latakplugin/gotennaproag/jQ$a;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    :try_end_0
