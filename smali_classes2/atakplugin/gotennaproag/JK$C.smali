.class public final Latakplugin/gotennaproag/JK$C;
...
.field private static final y:Latakplugin/gotennaproag/JK$C;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Latakplugin/gotennaproag/JK$C;-><init>()V

    sput-object v0, Latakplugin/gotennaproag/JK$C;->y:Latakplugin/gotennaproag/JK$C;

    new-instance v0, Latakplugin/gotennaproag/JK$C$a;

    invoke-direct {v0}, Latakplugin/gotennaproag/JK$C$a;-><init>()V

    sput-object v0, Latakplugin/gotennaproag/JK$C;->z:Latakplugin/gotennaproag/X51;
...
.method private constructor <init>()V
    ...
    iput-byte v0, p0, Latakplugin/gotennaproag/JK$C;->v:B
    ...
    iput-object v0, p0, Latakplugin/gotennaproag/JK$C;->s:Ljava/util/List;
...
.method private constructor <init>(Latakplugin/gotennaproag/rh0$b;)V
    ...
    iput-byte p1, p0, Latakplugin/gotennaproag/JK$C;->v:B
...
.method synthetic constructor <init>(Latakplugin/gotennaproag/rh0$b;Latakplugin/gotennaproag/JK$a;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Latakplugin/gotennaproag/JK$C;-><init>(Latakplugin/gotennaproag/rh0$b;)V

    return-void
.end method

.method public static Aa([BLatakplugin/gotennaproag/VZ;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    sget-object v0, Latakplugin/gotennaproag/JK$C;->z:Latakplugin/gotennaproag/X51;

    invoke-interface {v0, p0, p1}, Latakplugin/gotennaproag/X51;->w([BLatakplugin/gotennaproag/VZ;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Latakplugin/gotennaproag/JK$C;
...
.method static synthetic ga(Latakplugin/gotennaproag/JK$C;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Latakplugin/gotennaproag/JK$C;->s:Ljava/util/List;

    return-object p0
.end method

.method static synthetic ha(Latakplugin/gotennaproag/JK$C;Ljava/util/List;)Ljava/util/List;
    .locals 0

    iput-object p1, p0, Latakplugin/gotennaproag/JK$C;->s:Ljava/util/List;

    return-object p1
.end method

.method public static ia()Latakplugin/gotennaproag/JK$C;
    .locals 1

    sget-object v0, Latakplugin/gotennaproag/JK$C;->y:Latakplugin/gotennaproag/JK$C;
...
.method public static la()Latakplugin/gotennaproag/JK$C$d;
    .locals 1

    sget-object v0, Latakplugin/gotennaproag/JK$C;->y:Latakplugin/gotennaproag/JK$C;

    invoke-virtual {v0}, Latakplugin/gotennaproag/JK$C;->Ca()Latakplugin/gotennaproag/JK$C$d;
...
.method public static ma(Latakplugin/gotennaproag/JK$C;)Latakplugin/gotennaproag/JK$C$d;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {v0, p0}, Latakplugin/gotennaproag/JK$C$d;->pa(Latakplugin/gotennaproag/JK$C;)Latakplugin/gotennaproag/JK$C$d;
...
.method public static pa(Ljava/io/InputStream;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static qa(Ljava/io/InputStream;Latakplugin/gotennaproag/VZ;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static ra(Latakplugin/gotennaproag/nj;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static sa(Latakplugin/gotennaproag/nj;Latakplugin/gotennaproag/VZ;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static ta(Latakplugin/gotennaproag/Us;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static ua(Latakplugin/gotennaproag/Us;Latakplugin/gotennaproag/VZ;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static va(Ljava/io/InputStream;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static wa(Ljava/io/InputStream;Latakplugin/gotennaproag/VZ;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static xa(Ljava/nio/ByteBuffer;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static ya(Ljava/nio/ByteBuffer;Latakplugin/gotennaproag/VZ;)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static za([B)Latakplugin/gotennaproag/JK$C;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
# virtual methods
.method public Ca()Latakplugin/gotennaproag/JK$C$d;
    .locals 2
    ...
    new-instance v0, Latakplugin/gotennaproag/JK$C$d;

    invoke-direct {v0, v1}, Latakplugin/gotennaproag/JK$C$d;-><init>(Latakplugin/gotennaproag/JK$a;)V
...
.method protected bridge synthetic I9(Latakplugin/gotennaproag/rh0$c;)Latakplugin/gotennaproag/vQ0$a;
    ...
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/JK$C;->oa(Latakplugin/gotennaproag/rh0$c;)Latakplugin/gotennaproag/JK$C$d;
...
.method protected L9(Latakplugin/gotennaproag/rh0$i;)Ljava/lang/Object;
    ...
    new-instance p1, Latakplugin/gotennaproag/JK$C;

    invoke-direct {p1}, Latakplugin/gotennaproag/JK$C;-><init>()V
...
.method public Z2()I
    ...
    iget-object v0, p0, Latakplugin/gotennaproag/JK$C;->s:Ljava/util/List;
...
.method public e4(Latakplugin/gotennaproag/Ys;)V
    ...
    :goto_0
    iget-object v1, p0, Latakplugin/gotennaproag/JK$C;->s:Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v1, p1, Latakplugin/gotennaproag/JK$C;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JK$C;->q4()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p1}, Latakplugin/gotennaproag/JK$C;->q4()Ljava/util/List;
...
.method public bridge synthetic getDefaultInstanceForType()Latakplugin/gotennaproag/NQ0;
    ...
    .line 2
    invoke-virtual {p0}, Latakplugin/gotennaproag/JK$C;->ja()Latakplugin/gotennaproag/JK$C;
...
.method public getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Latakplugin/gotennaproag/JK$C;->s:Ljava/util/List;
...
.method public hashCode()I
    ...
    :cond_0
    invoke-static {}, Latakplugin/gotennaproag/JK$C;->ka()Latakplugin/gotennaproag/KK$b;
    ...
    invoke-virtual {p0}, Latakplugin/gotennaproag/JK$C;->Z2()I
...
.method public final isInitialized()Z
    ...
    iget-byte v0, p0, Latakplugin/gotennaproag/JK$C;->v:B
    ...
    :cond_1
    iput-byte v1, p0, Latakplugin/gotennaproag/JK$C;->v:B

    return v1
.end method

.method public ja()Latakplugin/gotennaproag/JK$C;
    .locals 1
...
.method public na()Latakplugin/gotennaproag/JK$C$d;
    .locals 1
...
.method public bridge synthetic newBuilderForType()Latakplugin/gotennaproag/NQ0$a;
    ...
    .line 2
    invoke-virtual {p0}, Latakplugin/gotennaproag/JK$C;->na()Latakplugin/gotennaproag/JK$C$d;
...
.method protected oa(Latakplugin/gotennaproag/rh0$c;)Latakplugin/gotennaproag/JK$C$d;
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-direct {v0, p1, v1}, Latakplugin/gotennaproag/JK$C$d;-><init>(Latakplugin/gotennaproag/rh0$c;Latakplugin/gotennaproag/JK$a;)V
