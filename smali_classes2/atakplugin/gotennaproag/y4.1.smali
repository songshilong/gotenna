.class public final Latakplugin/gotennaproag/y4;
...
.method constructor <init>()V
    ...
    new-instance v1, Latakplugin/gotennaproag/y4$a;

    const-class v2, Latakplugin/gotennaproag/M2;

    invoke-direct {v1, v2}, Latakplugin/gotennaproag/y4$a;-><init>(Ljava/lang/Class;)V
...
.method static synthetic l(ILatakplugin/gotennaproag/LD0$b;)Latakplugin/gotennaproag/XD0$a$a;
    ...
    invoke-static {p0, p1}, Latakplugin/gotennaproag/y4;->o(ILatakplugin/gotennaproag/LD0$b;)Latakplugin/gotennaproag/XD0$a$a;
...
.method public static final m()Latakplugin/gotennaproag/LD0;
    ...
    invoke-static {v0, v1}, Latakplugin/gotennaproag/y4;->p(ILatakplugin/gotennaproag/LD0$b;)Latakplugin/gotennaproag/LD0;
...
.method private static o(ILatakplugin/gotennaproag/LD0$b;)Latakplugin/gotennaproag/XD0$a$a;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Latakplugin/gotennaproag/w4$b;->K3(I)Latakplugin/gotennaproag/w4$b;
...
.method private static p(ILatakplugin/gotennaproag/LD0$b;)Latakplugin/gotennaproag/LD0;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static t(Z)V
    ...
    invoke-static {}, Latakplugin/gotennaproag/F4;->g()V
...
.method public g()Latakplugin/gotennaproag/XD0$a;
    ...
    new-instance v0, Latakplugin/gotennaproag/y4$b;

    const-class v1, Latakplugin/gotennaproag/w4;

    invoke-direct {v0, p0, v1}, Latakplugin/gotennaproag/y4$b;-><init>(Latakplugin/gotennaproag/y4;Ljava/lang/Class;)V
...
.method public bridge synthetic i(Latakplugin/gotennaproag/oj;)Latakplugin/gotennaproag/MQ0;
    ...
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/y4;->q(Latakplugin/gotennaproag/oj;)Latakplugin/gotennaproag/v4;
...
.method public bridge synthetic k(Latakplugin/gotennaproag/MQ0;)V
    ...
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/y4;->u(Latakplugin/gotennaproag/v4;)V

    return-void
.end method

.method public q(Latakplugin/gotennaproag/oj;)Latakplugin/gotennaproag/v4;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-static {p1, v0}, Latakplugin/gotennaproag/v4;->s4(Latakplugin/gotennaproag/oj;Latakplugin/gotennaproag/UZ;)Latakplugin/gotennaproag/v4;
...
.method public u(Latakplugin/gotennaproag/v4;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {p1}, Latakplugin/gotennaproag/v4;->getVersion()I

    move-result v0

    invoke-virtual {p0}, Latakplugin/gotennaproag/y4;->f()I

    move-result v1

    invoke-static {v0, v1}, Latakplugin/gotennaproag/HQ1;->j(II)V

    invoke-virtual {p1}, Latakplugin/gotennaproag/v4;->c()Latakplugin/gotennaproag/oj;
