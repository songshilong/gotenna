.class public final synthetic Latakplugin/gotennaproag/T6$a$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Latakplugin/gotennaproag/T6$a;
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/gotenna/atak/model/protobufs/AnyMessagePipe.ChatMessage.$serializer",
        "Lkotlinx/serialization/internal/GeneratedSerializer;",
        "Latakplugin/gotennaproag/T6$a;",
...
# static fields
.field public static final a:Latakplugin/gotennaproag/T6$a$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Latakplugin/gotennaproag/T6$a$a;

    invoke-direct {v0}, Latakplugin/gotennaproag/T6$a$a;-><init>()V

    sput-object v0, Latakplugin/gotennaproag/T6$a$a;->a:Latakplugin/gotennaproag/T6$a$a;

    new-instance v1, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;

    const-string v2, "com.gotenna.atak.model.protobufs.AnyMessagePipe.ChatMessage"
    ...
    new-instance v0, Latakplugin/gotennaproag/T6$h$a$a;

    invoke-direct {v0, v2}, Latakplugin/gotennaproag/T6$h$a$a;-><init>(I)V
    ...
    invoke-direct {v0, v4}, Latakplugin/gotennaproag/T6$h$a$a;-><init>(I)V
    ...
    invoke-direct {v0, v3}, Latakplugin/gotennaproag/T6$h$a$a;-><init>(I)V

    invoke-virtual {v1, v0}, Lkotlinx/serialization/internal/PluginGeneratedSerialDescriptor;->pushAnnotation(Ljava/lang/annotation/Annotation;)V

    sput-object v1, Latakplugin/gotennaproag/T6$a$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Latakplugin/gotennaproag/T6$a$a;->e(Lkotlinx/serialization/encoding/Decoder;)Latakplugin/gotennaproag/T6$a;
...
.method public final e(Lkotlinx/serialization/encoding/Decoder;)Latakplugin/gotennaproag/T6$a;
    .locals 25
    ...
    sget-object v1, Latakplugin/gotennaproag/T6$a$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v5, Latakplugin/gotennaproag/T6$h$a;->a:Latakplugin/gotennaproag/T6$h$a;

    invoke-interface {v0, v1, v3, v5, v9}, Lkotlinx/serialization/encoding/CompositeDecoder;->decodeNullableSerializableElement(Lkotlinx/serialization/descriptors/SerialDescriptor;ILkotlinx/serialization/DeserializationStrategy;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Latakplugin/gotennaproag/T6$h;
    ...
    :pswitch_0
    sget-object v8, Latakplugin/gotennaproag/T6$h$a;->a:Latakplugin/gotennaproag/T6$h$a;
    ...
    check-cast v14, Latakplugin/gotennaproag/T6$h;
    ...
    new-instance v0, Latakplugin/gotennaproag/T6$a;

    const/16 v24, 0x0

    move-object/from16 v16, v0

    invoke-direct/range {v16 .. v24}, Latakplugin/gotennaproag/T6$a;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Latakplugin/gotennaproag/T6$h;Lkotlinx/serialization/internal/SerializationConstructorMarker;)V
...
.method public final f(Lkotlinx/serialization/encoding/Encoder;Latakplugin/gotennaproag/T6$a;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/Encoder;
        .annotation build Latak/core/aqp;
        .end annotation
    .end param
    .param p2    # Latakplugin/gotennaproag/T6$a;
        .annotation build Latak/core/aqp;
        .end annotation
    .end param
    ...
    sget-object v0, Latakplugin/gotennaproag/T6$a$a;->b:Lkotlinx/serialization/descriptors/SerialDescriptor;

    invoke-interface {p1, v0}, Lkotlinx/serialization/encoding/Encoder;->beginStructure(Lkotlinx/serialization/descriptors/SerialDescriptor;)Lkotlinx/serialization/encoding/CompositeEncoder;

    move-result-object p1

    invoke-static {p2, p1, v0}, Latakplugin/gotennaproag/T6$a;->u(Latakplugin/gotennaproag/T6$a;Lkotlinx/serialization/encoding/CompositeEncoder;Lkotlinx/serialization/descriptors/SerialDescriptor;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    check-cast p2, Latakplugin/gotennaproag/T6$a;

    invoke-virtual {p0, p1, p2}, Latakplugin/gotennaproag/T6$a$a;->f(Lkotlinx/serialization/encoding/Encoder;Latakplugin/gotennaproag/T6$a;)V
