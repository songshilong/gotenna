...
.method public static a(J)Ljava/lang/String;
    ...
    :try_start_0
    sget-object v0, Latakplugin/gotennaproag/gG;->i:Latakplugin/gotennaproag/gG;

    invoke-virtual {v0}, Latakplugin/gotennaproag/gG;->getValue()Ljava/lang/String;
...
.method public static b(ILjava/lang/String;)Landroid/app/AlertDialog;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static c(III)Landroid/app/AlertDialog;
    .locals 3
    .param p1    # I
...
.method public static d(II)Landroid/app/AlertDialog;
    .locals 2
    .param p0    # I
        .annotation build Landroidx/annotation/StringRes;
        .end annotation
...
.method public static f(Lcom/atakmap/android/contact/t;)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {p0, v0}, Lcom/atakmap/android/contact/t;->f(Z)Ljava/util/Collection;
    ...
    check-cast v1, Lcom/atakmap/android/contact/b;

    invoke-virtual {v1}, Lcom/atakmap/android/contact/b;->a()Ljava/lang/String;

    move-result-object v1

    const-string v2, "com.gotenna.atak.SEND_CHAT"
...
.method public static g(Lcom/atakmap/android/contact/t;)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {p0, v0}, Lcom/atakmap/android/contact/t;->h(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/atakmap/android/contact/t;->f(Z)Ljava/util/Collection;
    ...
    check-cast v0, Lcom/atakmap/android/contact/b;

    invoke-virtual {v0}, Lcom/atakmap/android/contact/b;->a()Ljava/lang/String;
...
.method public static k()Ljava/lang/String;
    ...
    const-string v0, "2.2.61"

    return-object v0
.end method

.method public static l(Latakplugin/gotennaproag/dG0$a;I)V
    .locals 0
    .param p0    # Latakplugin/gotennaproag/dG0$a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/MethodParameters;
    ...
    invoke-static {p0, p1}, Latakplugin/gotennaproag/Qg0;->m(Ljava/util/List;Ljava/util/List;)V
...
.method public static m(Ljava/util/List;Ljava/util/List;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
            "Latakplugin/gotennaproag/dG0$a;",
            ">;",
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
            ">;)V"
    ...
    check-cast v2, Latakplugin/gotennaproag/dG0$a;

    invoke-static {v2}, Latakplugin/gotennaproag/dG0;->d(Latakplugin/gotennaproag/dG0$a;)Z
    ...
    sget-object v4, Latakplugin/gotennaproag/dG0$a;->f:Latakplugin/gotennaproag/dG0$a;

    if-ne v2, v4, :cond_3

    invoke-static {v4, v3}, Latakplugin/gotennaproag/dG0;->c(Latakplugin/gotennaproag/dG0$a;Z)V
    ...
    invoke-direct {v0, p0}, Latakplugin/gotennaproag/Qg0$b;-><init>(Ljava/util/List;)V
...
.method public static o(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Latakplugin/gotennaproag/Qg0;->p(Ljava/lang/String;I)V
...
.method public static p(Ljava/lang/String;I)V
    ...
    invoke-direct {v1, p0, p1}, Latakplugin/gotennaproag/Qg0$a;-><init>(Ljava/lang/String;I)V
